...
namespace eastsussexgovuk.webservices.EgmsWebMetadata
{
    ...
    /// <para>The second example shows how to specify the paths to these XML files using the <c>EsccWebTeam.Egms/ControlledListXml</c> element in <b>web.config</b>.</para>
    /// <code>
    ///		&lt;configSections&gt;
