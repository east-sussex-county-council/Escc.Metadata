...
namespace EsccWebTeam.Egms
{
    ...
    public class CssInject : CssImport
    {
        ...
        protected override void CreateChildControls()
        {
            ...
            {
                throw new ArgumentException("DestinationPlaceholder property must be set to the name of the ContentPlaceholder to inject the CSS into");
            }
